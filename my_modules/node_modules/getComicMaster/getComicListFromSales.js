...
/*
 * GMT日付変換処理
 * 概　要 : 日付文字列をGMT形式に変換する
 * 引　数 : in_YMD yyyyMMdd形式の日付文字列
 * 戻り値 : 変換後のDateオブジェクト
 */
function makeGMTDate(in_YMD){
  var _year = in_YMD.substr(0, 4),
      _month = in_YMD.substr(4, 2),
      _day = in_YMD.substr(6, 2);
  return new Date(_year+'-'+_month+'-'+_day+'T00:00:00.000+09:00');
}
